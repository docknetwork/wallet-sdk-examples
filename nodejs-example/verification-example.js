...
async function main() {
  ...
  const {data: rawCredential} = await axios.get('https://creds-testnet.dock.io/8489dc69b69a70c97646ad9b4f256acaddb57762b5a6f661f0c9dae3b7f72ea6', {
    params: {
        p: btoa('test'),
    }
  });
  ...
  await verificationController.start({
    template: 'https://creds-testnet.dock.io/proof/7eac58b2-125a-49db-a3c5-c4ac2cc030cc',
  });
  ...
  try {
    ...
    const verificationResponse = await controller.submitPresentation(presentation);
